...
namespace TikTakGraphQLSupport.Services;

public class AuthService(ApplicationDbContext dbContext, IOptions<JwtOptions> options, TokenGenerator tokenGenerator)
{
    public async Task<CSharpFunctionalExtensions.Result<string>> RefreshTokenAsync(HttpContext httpContext)
    {
    ...
    public async Task<CSharpFunctionalExtensions.Result<User?>> ValivateUserAsync(LoginDto loginDto, HttpContext httpContext)
    {
    ...
    public async Task<CSharpFunctionalExtensions.Result<User>> RegisterAsync(RegisterDto registerDto, HttpContext httpContext)
    {
    ...
    public async Task<CSharpFunctionalExtensions.Result<User>> LoginAsync(LoginDto loginDto, HttpContext httpContext)
    {
        var user = await ValivateUserAsync(loginDto, httpContext);
